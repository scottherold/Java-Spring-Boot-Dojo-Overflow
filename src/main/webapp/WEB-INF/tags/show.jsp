...
<html>
	...
	<title>Dojo Overflow : Questions by Subject</title>
	</head>
	<body class="bg-light">
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col bg-white p-3">
					<div class="row p-4">
						<h1>Subject: <c:out value="${subject}" /></h1>
					</div>
					<div class="row justify-content-center px-4">
						...
						<c:if test="${empty questions}" >
							<hr>
							<div class="col p-3">
								<h3 class="text-center">No questions found for this subject... Be the first!</h3>
							</div>							
						</c:if>
					</div>
					<hr>
